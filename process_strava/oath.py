...
def authenticate_save_token(
    client, client_id, client_secret, path_to_save="access_token.pickle"
):
    code = get_code(client, client_id)
...
def authenticate(secrets, client, verbose=True):
    ...
    if not os.path.exists(path_to_save):
        authenticate_save_token(client, client_id, client_secret)
